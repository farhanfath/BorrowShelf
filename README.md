...
- [Netbeans Project Version](https://github.com/farhanfath/BorrowShelf/tree/main)
...
2. Clone repositori ini ke dalam komputer Anda:
   ...
   ```bash
   git clone https://github.com/farhanfath/BorrowShelf.git
    ```
